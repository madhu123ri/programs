...
if($duser==$user && $dpwd==$pwd)
{
    ...
    echo "<h3 align=center><big>Enjoy our service.........!!!!!!!!!!!!!!</h3></big>";
     echo "<h3 align=center><big></h3></big>";

}
else
{
echo "<html><body bgcolor='skyblue'>
              <h4 align=center><big>HELLO Mr $user<br>";/*Your Login is success</h1></big>";*/
    echo "<h3 align=center><big>YOUR NOT AUTHORISED USER TO VISIT THIS PAGE...!!!!!!!!!!!!!!</h3></big>";
}
